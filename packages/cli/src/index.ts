...
/**
 * @minions-applications/cli — CLI for Minions applications
 *
...
import { customTypes } from '@minions-applications/sdk';
...
program.name('applications').description('Application records, submission bundles, platform receipts, and status tracking').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions applications'));
    console.log(chalk.dim('Application records, submission bundles, platform receipts, and status tracking'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-applications/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-applications/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_applications')}`);
