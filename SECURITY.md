...
- `@minions-applications/sdk` (npm package)
- `minions-applications` (PyPI package)
- `@minions-applications/cli` (npm package)
- The minions-applications web playground
- The minions-applications documentation site
